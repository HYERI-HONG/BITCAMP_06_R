...
##working directory의 약자 ->wd
##working directory 위치 확인, 설정
##새로 설정할 경우 먼저 폴더 생성하고 setwd()할것
path<-getwd()
path
setwd("csv_exam")
...
#문자가 들어있는 파일을 불러올때는 위의 파일명 뒤에 stringAsFactors=F 를 넣어줄것
#지정하지 않으면 문자요소는 factor로 전환됨, 숫자는 전환 되지 않음
